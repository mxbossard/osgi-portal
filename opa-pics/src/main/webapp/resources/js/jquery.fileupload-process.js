/*
 * jQuery File Upload Processing Plugin 1.2.2 https://github.com/blueimp/jQuery-File-Upload Copyright 2012, Sebastian
...
(function(factory) {
	...
	$.widget('blueimp.fileupload', $.blueimp.fileupload, {
		...
		processActions : {
		/*
		 * log: function (data, options) { console[options.type]( 'Processing "' + data.files[data.index].name + '"' ); }
		 */
		},
