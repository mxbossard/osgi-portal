...
public interface IUserAction {
	 ...
	 * the property has only one value. If the property might have more than one value, use
	 * getProperties(java.lang.String). If this method is used with a multivalued parameter, the value returned is equal
	 * to the first value in the Enumeration returned by getProperties.
	 * 
	 * @param name
	 *            a String specifying the property name
	 * @return a String containing the value of the requested property, or null if the request does not have a property
	 *         of that name.
	 ...
	 * @param name
	 *            a String specifying the property name
	 * @return an Enumeration containing the values of the requested property. If the request does not have any
	 *         properties of that name return an empty Enumeration.
	 * @throws IllegalArgumentException
	 *             - if name is null.
	 */
	...
	/**
	 * Returns a Enumeration of all the property names this request contains. If the request has no properties, this
	 * method returns an empty Enumeration.
	 * 
	 * @return an Enumeration of all the property names sent with this request; if the request has no properties, an
	 *         empty Enumeration.
	 */
	Iterable<java.lang.String> getPropertyNames();

	/**
	 * Returns the value of a request parameter as a String, or null if the parameter does not exist. Request parameters
	 * are extra information sent with the request. The returned parameter are "x-www-form-urlencoded" decoded. Only
	 * parameters targeted to the current portlet are accessible. This method should only be used if the parameter has
	 * only one value. If the parameter might have more than one value, use getParameterValues(java.lang.String). If
	 * this method is used with a multivalued parameter, the value returned is equal to the first value in the array
	 ...
	 * parameter does not exist. The returned parameters are "x-www-form-urlencoded" decoded. If the parameter has a
	 ...
	 * request has no parameters, the method returns an empty Enumeration. Only parameters targeted to the current
	 ...
	 * The returned parameters are "x-www-form-urlencoded" decoded. The values in the returned Map are from type String
	 * array (String[]). If no parameters exist this method returns an empty Map.
	 * 
	 * @return an immutable Map containing parameter names as keys and parameter values as map values, or an empty Map
	 *         if no parameters exist. The keys in the parameter map are of type String. The values in the parameter map
	 ...
	 * java.*, and javax.*. In a distributed portlet web application the Object needs to be serializable.
	 * 
	 * @param name
	...
	/**
	 * Returns an Enumeration containing the names of the attributes available to this request. This method returns an
	 * empty Enumeration if the request has no attributes available to it.
	 * 
	 * @return an Enumeration of strings containing the names of the request attributes, or an empty Enumeration if the
	 *         request has no attributes available to it.
	 */
	Iterable<java.lang.String> getAttributeNames();

	/**
	 * Stores an attribute in this request. Attribute names should follow the same conventions as package names. Names
	 * beginning with java.*, javax.*, and com.sun.* are reserved.
	 * 
	 * @param name
	 *            a String specifying the name of the attribute
	 * @param value
	 ...
	 * as the request is being handled. Attribute names should follow the same conventions as package names. Names
	 * beginning with java.*, javax.*, and com.sun.* are reserved.
	 * 
	 * @param name
	 *            a String specifying the name of the attribute
