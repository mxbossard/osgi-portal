 ...
 * There is one context per application per Java Virtual Machine. As a web application, an application also has a servlet context. The app context leverages most of its functionality from the servlet context of the application.
 * Attributes stored in the context are global for all users and all components in the application.
